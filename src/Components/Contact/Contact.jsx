...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_n63apnf', 'template_4irk6v6', contactRef.current, 'bLaKQthGAC8_4kbYf')
          .then((result) => {
              setSuccess(true)
        ...
        <motion.div ref={ref} className="contact" variants={variants} initial="initial" animate="animate">
            <motion.div className="textContainer" variants={variants}>
                ...
                <motion.div className="item" variants={variants}>
                    <h2>Mail</h2>
                    <span>shaiharan7@gmail.com</span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>Address</h2>
                    <span>12/201 Bharathi Nagar, Thuckalay</span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>Phone</h2>
                    <span>+91 7904118287</span>
                </motion.div>
            </motion.div>
            <div className="formContainer">
                <motion.div className="phoneSvg" initial={{opacity:1}} whileInView={{opacity:0}} transition={{delay:3, duration:1}}>
                    <svg viewBox="0 0 512 512">
                        <motion.path strokeWidth={5} fill='none' initial={{ pathLength: 0}} animate={isInView && { pathLength: 1}} transition={{ duration:3}}
                ...
                <motion.form ref={contactRef} onSubmit={sendEmail} initial={{opacity:0}} whileInView={{opacity:1}} transition={{delay:4, duration:1}}>
